...
def JustFollowRightWall() -> None :
    ...
    Fonction : La fonction JustFollowRightWall est la fonction de mouvement principale de la second mode de
    resolution de labyrinthe. Elle ajuste la position du robot pour que le capteur #3 soit toujours sur le mur
